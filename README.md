[![Build Status](https://travis-ci.com/rafael-pieri/microservices-with-spring-cloud.svg?branch=master)](https://travis-ci.com/rafael-pieri/microservices-with-spring-cloud)
